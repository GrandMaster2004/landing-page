...
const instagramImages = [
  { src: "/figmaAssets/img.png" },
  { src: "/figmaAssets/img-1.png" },
  { src: "/figmaAssets/img-2.png" },
  { src: "/figmaAssets/monica-silva-wpfhdtwqfta-unsplash.png" },
  { src: "/figmaAssets/img-3.png" },
];
  ...
  VIEW SWEETENERS
    ...
    className="absolute z-20 w-full mt-[-80px] sm:mt-[-100px] lg:mt-[-160px] h-[150px] sm:h-[200px] lg:h-[251px] object-fill"
      ...
      <div className="relative w-full ">
        ...
        {/* Quiz Section - Fixed Spacing - MOBILE LAYOUT MATCHING FIGMA */}
    <section
...
>
{/* MOBILE: Image on top, text below (matching Figma) */}
<div className="block lg:hidden w-full">
  {/* Decorative Star - top right of image */}
  <div className="relative">
    <img
      className="absolute -top-4 -right-2 w-[60px] h-[65px] rotate-[15deg] z-10"
    ...
    <img
      className="absolute -bottom-6 -left-4 w-[70px] h-[75px] rotate-[-18deg]"
      src="/figmaAssets/cyan-2--1--1.png"
      alt=""
    />
  </div>
...
{/* TEXT SIDE - MOBILE: centered below image */}
<div className="block lg:hidden w-full text-center px-2">
  ...
  <p className="text-brand-color3 text-base font-medium mb-6 px-2">
    Take a short quiz to find out which Splenda products are right for you.
  </p>

  <Button
    className="w-[140px] h-[48px] bg-brand-color3 rounded-full border border-black shadow-[2px_2px_0px_#000] text-white text-base font-bold"
  >
    TAKE QUIZ
  </Button>
</div>
...
{/* IMAGE SIDE */}
<div className="hidden lg:block relative w-full max-w-[624px]">
  {/* Decorative Star */}
  <img
    className="absolute -bottom-30 -right-23 mb-[90px] w-[80px] h-[90px] sm:w-[100px] sm:h-[114px] lg:w-[130px] lg:h-[144px] rotate-[15deg] z-10"
    src="/figmaAssets/cyan-2--1--1.png"
    alt=""
  />
  ...
  <img
    className="absolute -bottom-12 -right-12 w-[100px] h-[103px] sm:w-[140px] sm:h-[144px] lg:w-[189px] lg:h-[194px] rotate-[-18deg]"
    src="/figmaAssets/cyan-2--1--1.png"
    alt=""
  />
</div>
...
{/* TEXT SIDE - DESKTOP */}
<div className="hidden lg:block max-w-[500px] text-center lg:text-left">
...
<div className="absolute bottom-[-60px] left-0 w-full z-0 group">
  ...
  <div className="px-4 sm:px-10 lg:px-[80px] mb-6 sm:mb-8 lg:mb-10 relative">
    ...
    <div className="flex items-start gap-3 relative">
      ...
      {/* ⭐ Sparkle Star - Visible on ALL screens */}
      <img
        src="/figmaAssets/cyan-2--1--1.png"
        alt="star"
        className="
  ...
  {/* Instagram Section - UPDATED FOR MOBILE TO MATCH FIGMA */}
 <section
  className="
    relative
    overflow-hidden
...
>
          ...
          <div 
            className="instagram-carousel-container group relative overflow-hidden pb-5 pt-8" 
          >
            <div 
            ...
            >
              ...
              {[...instagramImages, ...instagramImages].map((img, index) => (
                <div 
                  key={index}
                  className="instagram-card group/card relative shrink-0 [width:clamp(200px,50vw,280px)] rounded-[16px] overflow-hidden bg-white shadow-[0_4px_15px_rgba(0,0,0,0.1)] transition-transform duration-300 hover:scale-[1.02] hover:shadow-[0_8px_25px_rgba(0,0,0,0.2)]"
                >
                  {/* Instagram Header - Shows on hover (OUTSIDE effect) */}
                  <div 
                    className="instagram-header absolute inset-x-0 top-0 bg-white py-3 px-[14px] flex items-center justify-between opacity-0 group-hover/card:opacity-100 -translate-y-full group-hover/card:translate-y-0 transition-all duration-300 ease-out z-10"
                  >
                  ...
                  {/* Instagram Footer - Shows on hover (OUTSIDE effect) */}
                  <div 
                    className="instagram-footer absolute inset-x-0 bottom-0 bg-white py-3 px-[14px] flex justify-between items-center opacity-0 group-hover/card:opacity-100 translate-y-full group-hover/card:translate-y-0 transition-all duration-300 ease-out z-10"
                  >
          ...
          {/* Bottom section with @SPLENDA button and Follow socials - MOBILE UPDATED */}
          <div className="flex flex-col items-center justify-center gap-6 lg:gap-0 pt-8 sm:pt-16 lg:pt-[90px] px-4 max-[1200px]:pb-6 sm:px-6 pb-40 sm:pb-60 relative z-5">
            {/* @SPLENDA Button - MOBILE: centered */}
            ...
            {/* Follow Our Socials - MOBILE: centered below button */}
            <div className="text-center lg:text-right">
              ...
              <div className="flex gap-2 sm:gap-3 justify-center lg:justify-end">
                {/* Instagram */}
                <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-[#0C3C60] flex items-center justify-center cursor-pointer hover:bg-[#1a4a6e] transition-colors">
...
>
  ...
  <div className="hidden sm:grid px-4 sm:px-6 lg:px-[100px] pt-6 sm:pt-8 lg:pt-[40px] grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 justify-center gap-10 sm:gap-8 lg:gap-6 min-[1100px]:max-[1279px]:gap-4 lg:max-[1279px]:gap-4 xl:gap-16 relative z-20">
    {merchProducts.map((product, index) => (
      ...
      >
        {/* Oval Container */}
        <div className="w-[260px] h-[180px] sm:w-[300px] sm:h-[200px] lg:w-[280px] lg:h-[190px] min-[1100px]:max-[1279px]:w-[260px] min-[1100px]:max-[1279px]:h-[178px] lg:max-[1279px]:w-[260px] lg:max-[1279px]:h-[178px] xl:w-[370px] xl:h-[250px] bg-white rounded-[250%] rotate-[-5deg] flex items-center justify-center mb-4 sm:mb-5 lg:mb-6 shadow-lg transition-transform duration-300 hover:scale-[1.03]">
          <img
            src={product.image}
            alt={product.title}
                ...
                <div className="flex items-center justify-center lg:justify-start gap-3 sm:gap-4 flex-wrap">
                  ...
                  <a href="#" className="text-brand-color3 hover:text-brand-color2 transition-colors">
                    <svg width="28" height="20" viewBox="0 0 28 20" fill="currentColor">
                      <path d="M27.4 3.1c-.3-1.2-1.2-2.1-2.4-2.4C22.9 0 14 0 14 0S5.1 0 3 .7C1.8 1 .9 1.9.6 3.1 0 5.2 0 10 0 10s0 4.8.6 6.9c.3 1.2 1.2 2.1 2.4-2.4.6-2.1.6-6.9.6-6.9s0-4.8-.6-6.9zM11.2 14.2V5.8l7.4 4.2-7.4 4.2z"/>
                    </svg>
                  </a>
                  {/* TikTok */}
                  <a href="#" className="text-brand-color3 hover:text-brand-color2 transition-colors">
